...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = () => {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center space-y-2 sm:space-y-4 ${terminalClasses.container} px-4 sm:px-6 md:px-2`}
    >
      ...
      <div className="text-center w-full max-w-full">
          ...
          <span className={terminalClasses.baseText} style={terminalStyles.baseText}>
            {(() => {
              const connectingText =
                terminalWidth < 50 ? ' CONNECTING TO PI ' : ' CONNECTING TO RASPBERRY PI ';
        ...
        <div className="w-full flex items-center mb-1 sm:mb-2">
          ...
          <span
            className={`flex-1 px-1 sm:px-2 text-center ${terminalClasses.baseText}`}
        ...
        <div className="w-full flex items-center mb-1 sm:mb-2">
          ...
          >
            {(() => {
              ...
              // Adjust calculation to ensure we can reach 100% fill
              // Map spinnerFrame (0-3) to fill percentages: 0.25, 0.5, 0.75, 1.0
              const fillPercentage = (spinnerFrame + 1) / spinnerChars.length;
              const filled = Math.round(barLength * fillPercentage);
